var PhaserGameObject = (function () {
    ...
    PhaserGameObject.prototype.init = function (el, parent, options) {
        ...
        function preloadComplete() {
            ...
            phaserButtons.add({ key: 'btn1', groupKey: 'group1', x: game.world.centerX - 175, y: 100, reference: 'orangeBtn', onclick: function () { setToRotate(); } });
            phaserButtons.add({ key: 'btn2', groupKey: 'group1', x: game.world.centerX, y: 100, reference: 'orangeBtn', onclick: function () { setToScale(); } });
            phaserButtons.add({ key: 'btn3', groupKey: 'group1', x: game.world.centerX + 175, y: 100, reference: 'orangeBtn', onclick: function () { setToMove(); } });
...
var PHASER_BUTTON_MANAGER = (function () {
    ...
    PHASER_BUTTON_MANAGER.prototype.destroyGroup = function (groupKey) {
        var keys = [];
        var deleteSpriteArray = this.resources.array.filter(function (sprite) {
    ...
    PHASER_BUTTON_MANAGER.prototype.getGroup = function (groupKey) {
...
var PHASER_SPRITE_MANAGER = (function () {
    ...
    PHASER_SPRITE_MANAGER.prototype.destroy = function (key) {
        ...
        for (var _i = 0, deleteSpriteArray_3 = deleteSpriteArray; _i < deleteSpriteArray_3.length; _i++) {
            var sprite = deleteSpriteArray_3[_i];
            keys.push(sprite.key);
            sprite.destroy();
        }
        delete this.resources.object[key];
    ...
    PHASER_SPRITE_MANAGER.prototype.destroyGroup = function (groupKey) {
        var keys = [];
        var deleteSpriteArray = this.resources.array.filter(function (sprite) {
            return sprite.groupKey === groupKey;
        });
        for (var _i = 0, deleteSpriteArray_4 = deleteSpriteArray; _i < deleteSpriteArray_4.length; _i++) {
            var sprite = deleteSpriteArray_4[_i];
            keys.push(sprite.key);
            sprite.destroy();
        }
        delete this.resources.object[groupKey];
...
var PHASER_TEXT_MANAGER = (function () {
    ...
    PHASER_TEXT_MANAGER.prototype.add = function (data) {
        var duplicateCheck = this.texts.array.filter(function (texts) {
    ...
    PHASER_TEXT_MANAGER.prototype.destroy = function (key) {
        var keys = [];
        var deleteTextArray = this.texts.array.filter(function (sprite) {
            return sprite.key === key;
        });
        ...
        this.texts.array = this.texts.array.filter(function (text) {
            return text.key !== key;
        });
        return keys;
    };
    PHASER_TEXT_MANAGER.prototype.destroyGroup = function (groupKey) {
        var keys = [];
        var deletearray = this.texts.array.filter(function (texts) {
    ...
    PHASER_TEXT_MANAGER.prototype.getGroup = function (groupKey) {
        return this.texts.array.filter(function (text) {
            return text.groupKey === groupKey;
        });
    };
